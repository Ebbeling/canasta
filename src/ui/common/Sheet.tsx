  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        ...
        tabIndex={-1}
        className="relative w-full max-w-page rounded-t-sheet bg-panel px-5 pt-2.5 pb-[calc(env(safe-area-inset-bottom)+1.375rem)] shadow-sheet outline-none sm:mb-6 sm:rounded-b-sheet"
      >
